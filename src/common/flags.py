...
class BenchmarkFlags(Flags):
    ...
    def _add_run_md_args(self):
        ...
        self.parser.add_argument(
            ...
            default=None,
            type=str,
            help="Path to a file including an initial structure for the MD simulation",
        )
        self.parser.add_argument(
            "--output-trajectory",
            default=None,
            type=str,
            help="Path to a trajectory generated by a given MLFF model",
        )
    ...
    def _add_evaluate_args(self):
        self.parser.add_argument(
            ...
            default=None,
            type=str,
            help="Evaluation metrics (rdf, adf, eos, pew)",
        )
        self.parser.add_argument(
            "--reference-trajectory",
            default=None,
            type=str,
            help="Path to a reference trajectory obtained from an ab-initio simulatior such as VASP",
        )
        self.parser.add_argument(
            "--generated-trajectory",
            default=None,
            type=str,
            help="Path to a trajectory which was generated by a given MLFF model (using --mode run-md)",
        )
