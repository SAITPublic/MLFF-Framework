...
EXPDIR=/home/workspace/MLFF/NeurIPS23_DnB-exp/SiN_v1.0/DimeNet++

# OCP config
CONFIG=NeurIPS23_DnB/configs/SiN_v1.0/dimenet_pp.yml
#EXPID=Rmax6_MaxNeigh50_otf_WarmupStepLR_LR1e-4_EP80_E1_MSE_F50_MSE_BS4_2GPU

# with some SAIT modifications
EXPID=Rmax6_MaxNeigh50_otf_NormOn_LinearLR_LR1e-4_EP200_E1_MSE_F50_MSE_BS4_1V100



# paper model config
CONFIG=NeurIPS23_DnB/configs/SiN_v1.0/paper_models/dimenet_pp.yml
