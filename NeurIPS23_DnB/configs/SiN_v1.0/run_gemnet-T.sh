...
EXPDIR=/home/workspace/MLFF/NeurIPS23_DnB-exp/SiN_v1.0/GemNet-T

# OCP config
CONFIG=NeurIPS23_DnB/configs/SiN_v1.0/gemnet-T.yml
...
# paper model cofnig
CONFIG=NeurIPS23_DnB/configs/SiN_v1.0/paper_models/gemnet-T.yml
