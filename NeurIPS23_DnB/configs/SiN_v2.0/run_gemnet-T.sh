...
# paper model config
CONFIG=NeurIPS23_DnB/configs/SiN_v2.0/paper_models/gemnet-T.yml
...
#EXPID=Paper_Model_Rmax6_MaxNeigh50_otf_NormOn_LinearLR_LR5e-4_EP200_E1_MAE_F100_L2MAE_EMA999_BS8_2V100 
#EXPID=Paper_Model_Rmax6_MaxNeigh50_otf_NormOff_LinearLR_LR5e-4_EP200_E1_MAE_F100_L2MAE_EMA999_BS8_2V100 


# norm off + SAIT loss
#EXPID=Paper_Model_Rmax6_MaxNeigh50_otf_NormOff_LinearLR_LR5e-3_EP200_SAITLoss_EMA999_BS4_1V100 

# norm per atom + SAIT loss
EXPID=Paper_Model_Rmax6_MaxNeigh50_otf_NormPerAtomOn_LinearLR_LR5e-3_EP200_SAITLoss_EMA999_BS4_1V100 
